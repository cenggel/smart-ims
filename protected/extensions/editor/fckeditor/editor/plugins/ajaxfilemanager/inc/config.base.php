...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../uploads/editorfiles/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../uploads/editorfiles/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,pdf,xls,doc,docx,doc,ppt,pptx'); // 
	...
	define("CONFIG_VIEWABLE_VALID_EXTS", 'gif,bmp,txt,jpg,png,tif,html,htm,js,css,xml,xsl,dtd,mp3,wav,wmv,wma,rm,rmvb,mov,swf,pdf,xls,doc,docx,doc,ppt,pptx');

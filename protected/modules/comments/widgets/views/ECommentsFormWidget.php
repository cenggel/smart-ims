...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        <?php echo $form->labelEx($newComment, 'comment_title'); ?>
        <?php echo $form->textField($newComment, 'comment_title', array('class'=>'text-input medium-input')); ?>
        <?php echo $form->error($newComment, 'comment_title'); ?>
    </div>
    <div class="row">

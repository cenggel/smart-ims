...
try {
    ...
    WdatePicker; (function() {
        var _ = {
            $wdate: true,
            $dpPath: globalCp + "/scripts/My97DatePicker/",
            $crossFrame: false,
...
specialDates: null,
            ...
            obj = {
                ...
                $DV: function(_, $) {
                    if (_ != "") {
                        ...
                        if ($) for (var A in $) {
                            if (this.dt[A] === undefined) this.errMsg = "invalid property23:" + A;
                            this.dt[A] += $[A]
                        }
        ...
        function K(H, $) {
            ...
            for (D in H) if ($dp[D] === undefined) $dp.errMsg = "invalid property44:" + D;
            else $dp[D] = H[D];
    ...
    primaryAlert(e.name + ";" + e.message + ";" + e.error);

<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('essential')); ?>:</b>
	<?php echo CHtml::encode($data->essential); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('article_date')); ?>:</b>
	<?php echo CHtml::encode($data->article_date); ?>
	<br />

 ...
 -->
        <DIV id=t_left class=t_left>
          <DIV id=show_Calendar>
            <SCRIPT>
	//控制月份选择
//	var otherMonth = $("otherMonth");
//	var sel_month = $("sele_month");
	function chooseMonth(event){
		var otherMonth = $("month");
		var sele_month = $("sele_month");
		var y = otherMonth.getPosition().y
		if(Browser.Engine.trident)y = y+20;
		var x = otherMonth.getPosition().x-25;
		sele_month.style.top = y + "px";
		sele_month.style.left = x + "px";
		sele_month.style.display = 'block';
		setTimeout(function(){
			if (window.document.body.addEventListener) {
				window.document.body.addEventListener("click", hiddenSelDate, false);
			} else {
				window.document.body.attachEvent("on" + "click", hiddenSelDate);
			}
		},1);
	...
	function chooseYear(event){
		var year = $("year");
		var sele_year = $("year_sele");
		var y = year.getPosition().y;
		if(Browser.Engine.trident)y = y+20;
		var x = year.getPosition().x-25;
		sele_year.style.top = y + "px";
		sele_year.style.left = x + "px";
		sele_year.style.display = 'block';
		setTimeout(function(){
			if (window.document.body.addEventListener) {
				window.document.body.addEventListener("click", hiddenSelDate, false);
			} else {
	...
	function get4Year(e,top){
		var y4 = $('year_1').value -5;
		if(top) y4 = $('year_4').value;
		for(var i=4;i>0;i--) {
			$('year_'+i).value = y4+i;  $('year_'+i).set('text', y4+i);
		}
		new Event(e).stop();
	}
</SCRIPT>
            <DIV style="DISPLAY: none" id=sele_month class=log_month_sele>
              <LI id=m0 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','0')">1</LI>
              <LI id=m1 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','1')">2</LI>
              <LI id=m2 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','2')">3</LI>
              <LI id=m3 class=foc onMouseOver="" onMouseOut="" onClick="changeMonth('2012','3')">4</LI>
              <LI id=m4 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','4')">5</LI>
              <LI id=m5 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','5')">6</LI>
              <LI id=m6 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','6')">7</LI>
              <LI id=m7 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','7')">8</LI>
              <LI id=m8 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','8')">9</LI>
              <LI id=m9 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','9')">10</LI>
              <LI id=m10 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','10')">11</LI>
              <LI id=m11 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth('2012','11')">12</LI>
            </DIV>
            <DIV style="DISPLAY: none" id=year_sele class=log_year_sele>
              <LI id=year_1 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth($(this).value,'3')" value=2010>2010</LI>
              <LI id=year_3 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth($(this).value,'3')" value=2012>2012</LI>
              <LI id=year_2 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth($(this).value,'3')" value=2011>2011</LI>
              <LI id=year_4 onMouseOver="this.className='mov'" onMouseOut="this.className=''" onClick="changeMonth($(this).value,'3')" value=2013>2013</LI>
              <DIV class=cb></DIV>
              <LI class=arrow onMouseOver="this.className='arrow mov'" onMouseOut="this.className='arrow'" onclick=get4Year(event)>←</LI>
              <LI class=close onMouseOver="this.className='close mov'" onMouseOut="this.className='close'" onclick=hiddenSelDate()>× </LI>
              <LI class=arrow onMouseOver="this.className='arrow mov'" onMouseOut="this.className='arrow'" onclick=get4Year(event,true)>→ </LI>
            </DIV>
            <DIV style="DISPLAY: block" class=calendar_view>
              <DIV class="ti_bg_nor ti"><B style="CURSOR: pointer" class="ico_le dleftarr_ico" onClick="changeMonth('2011','3')"></B><B style="CURSOR: pointer" class="ico_le leftarr_ico" onClick="changeMonth('2012','2')"></B><B style="CURSOR: pointer" class="ico_ri drightarr_ico" onClick="changeMonth('2013','3')"></B><B style="CURSOR: pointer" class="ico_ri rightarr_ico" onClick="changeMonth('2012','4')"></B>
                <DIV>
                  <DIV style="FLOAT: left">&nbsp;&nbsp;&nbsp;&nbsp;</DIV>
                  <DIV style="CURSOR: pointer" class=year>
                    <INPUT style="DISPLAY: none; COLOR: #808080" id=sele_year_text value=2012>
                    <SPAN id=year onClick="$('sele_year_text').setStyle('display','');chooseYear(event);$('year').setStyle('display','none');">2012</SPAN> </DIV>
                  <DIV class=fl>年</DIV>
                  <DIV style="CURSOR: pointer" class=month>
                    <INPUT style="DISPLAY: none; COLOR: #808080" id=sele_month_text class=wh value=4>
                    <SPAN id=month onClick="$('sele_month_text').setStyle('display','');chooseMonth(event);$('month').setStyle('display','none');">4</SPAN> </DIV>
                  <DIV class=fl>月</DIV>
                  <DIV class=cb></DIV>
                </DIV>
                <DIV class=cb></DIV>
              ...
              <DIV class=cb></DIV>
              <TABLE class=cont cellSpacing=0 cellPadding=3>
                <TBODY id=calendarWeek>
                  <TR>
                    <TD class=cont_leti></TD>
                    <TD class=ti_unline>日</TD>
                    <TD class=ti_unline>一</TD>
                    <TD class=ti_unline>二</TD>
                    <TD class=ti_unline>三</TD>
                    <TD class=ti_unline>四</TD>
                    <TD class=ti_unline>五</TD>
                    <TD class=ti_unline>六</TD>
                    <TD class=cont_ri></TD>
                  </TR>
                  <TR>
                    <TD id=weekTr0 class=cont_leti onMouseOver="this.parentNode.className='mov_row'" onMouseOut="this.parentNode.className=''"><A id=week0 class=unline onClick="javascript: selectWeekList('2012','3','1333209600000','1333728000000','0','0')" href="javascript:void(0)" ;>&gt;&gt;</A> </TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','1','1')">1</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','2','2')">2</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','3','3')">3</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','4','4')">4</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','5','5')">5</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','6','6')">6</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','7','7')">7</LI></TD>
                  </TR>
                  <TR>
                    <TD id=weekTr1 class=cont_leti onMouseOver="this.parentNode.className='mov_row'" onMouseOut="this.parentNode.className=''"><A id=week1 class=unline onClick="javascript: selectWeekList('2012','3','1333814400000','1334332800000','1','0')" href="javascript:void(0)" ;>&gt;&gt;</A> </TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','8','8')">8</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','9','9')">9</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','10','10')">10</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','11','11')">11</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','12','12')">12</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','13','13')">13</LI></TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','14','14')">14</LI></TD>
                  </TR>
                  <TR>
                    <TD id=weekTr2 class=cont_leti onMouseOver="this.parentNode.className='mov_row'" onMouseOut="this.parentNode.className=''"><A id=week2 class=unline onClick="javascript: selectWeekList('2012','3','1334419200000','1334937600000','2','0')" href="javascript:void(0)" ;>&gt;&gt;</A> </TD>
                    <TD><LI class=gray_box onClick="javascript:changeDay('2012','3','15','15')">15</LI></TD>
                    <TD><LI class=yell_box onClick="javascript:changeDay('2012','3','16','16')">16</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','17','17')">17</LI></TD>
                    <TD><LI class=blue_box onClick="javascript:changeDay('2012','3','18','18')">18</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','19','19')">19</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','20','20')">20</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','21','21')">21</LI></TD>
                  </TR>
                  <TR>
                    <TD id=weekTr3 class=cont_leti onMouseOver="this.parentNode.className='mov_row'" onMouseOut="this.parentNode.className=''"><A id=week3 class=unline onClick="javascript: selectWeekList('2012','3','1335024000000','1335542400000','3','0')" href="javascript:void(0)" ;>&gt;&gt;</A> </TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','22','22')">22</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','23','23')">23</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','24','24')">24</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','25','25')">25</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','26','26')">26</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','27','27')">27</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','28','28')">28</LI></TD>
                  </TR>
                  <TR>
                    <TD id=weekTr4 class=cont_leti onMouseOver="this.parentNode.className='mov_row'" onMouseOut="this.parentNode.className=''"><A id=week4 class=unline onClick="javascript: selectWeekList('2012','3','1335628800000','1336147200000','4','1')" href="javascript:void(0)" ;>&gt;&gt;</A> </TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','29','29')">29</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','3','30','30')">30</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','4','1','1')">1</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','4','2','2')">2</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','4','3','3')">3</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','4','4','4')">4</LI></TD>
                    <TD><LI class=future_box onClick="javascript:changeDay('2012','4','5','5')">5</LI></TD>
                  </TR>
                </TBODY>
              </TABLE>
            </DIV>
